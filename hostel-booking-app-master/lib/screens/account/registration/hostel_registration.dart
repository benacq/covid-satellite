...
class HostelRegistration extends StatefulWidget {
  ...
  HostelRegistration(blFirst);

  @override
  _HostelRegistrationState createState() =>
      new _HostelRegistrationState(blFirst);
}

class _HostelRegistrationState extends State<HostelRegistration>
          ...
          children: <Widget>[
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      ...
                      getTextFormFieldLogin(
                        ...
                        strHintText: "e.g. Adom Bi Hostel",
            ...
            Positioned(
              ...
              child: primaryRaisedButton(
                context: context,
                text: "Registration",
                textColor: myAppTheme.backgroundColor == Colors.white
                    ? Colors.white
                    : Colors.black,
              ),
            ),
                ...
                onPressed: () {
                  ...
                  if (!_formGeneralKey.currentState.validate()) {
                    showSnackBar(
                        ...
                        text: "Please fill in all th requried fields.");
                    return;
                  }
                  Navigator.pushReplacement(context,
                      new MaterialPageRoute(builder: (contex) => HomeScreen()));
                },
              ),
            )
          ],
