...
//  ));
  ...
  return ThemeData(
    ...
    textTheme: TextTheme(
        ...
        bodyText1: TextStyle(fontSize: size * 0.05, color: appBrightness == Brightness.light ? Colors.black : Colors.white70),
        bodyText2: TextStyle(fontSize: size * 0.045, color: appBrightness == Brightness.light ? Colors.black : Colors.white70)),
  );
}
